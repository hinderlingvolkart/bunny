...
var CalendarMarkup = {
    ...
    createTableBody: function createTableBody(year, month_index) {
        var current_day = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    ...
    createMonthSelect: function createMonthSelect() {
        var selected_month_index = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    ...
    createYearSelect: function createYearSelect() {
        var selected_year = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 2000;
        var min_year = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1950;
        var max_year = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2050;
...
var CalendarDecorator = {
    ...
    buildClass: function buildClass(classProperty) {
        var theme = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'def';
...
var Calendar = {
    ...
    create: function create() {
        var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'datepicker';
        var min_year = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1950;
        var max_year = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2050;
        var year = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
        var month_index = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
        var day = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
    ...
    show: function show(calendar_id) {
        var popup = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
