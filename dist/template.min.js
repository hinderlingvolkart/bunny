...
var TEMPLATE_EVENT_INIT = 'init';
var TEMPLATE_EVENT_FORMAT_DATA = 'format_data';
...
var Template = {
    ...
    isTable: function isTable(tpl_id) {
        return this._loadedTemplates[tpl_id].isTable;
    },

    create: function create(id, related_data) {
        var t = {};
        var attr_parts = [];
    ...
    callHandlers: function callHandlers(tpl) {
    ...
    append: function append(tpl, parent_el) {
    ...
    insert: function insert(tpl_id, data, parent_el) {
        return this.append(this.parse(data, this.create(tpl_id)), parent_el);
    },

    insertAll: function insertAll(tpl_id, data_collection, parent_el) {
        var f = document.createDocumentFragment();
        var tpl_collection = [];
    ...
    insertAdjacencyList: function insertAdjacencyList(tpl_id, data_adj_list, parent_el, parent_id_column, branch_container_class, order) {
        ...
        var append_node = function append_node(node, where) {
        ...
        var build_related_data = function build_related_data(node) {
            if (node.parent_id > 0) {
                var related_data = {};
